...
codegen compute_u_ccm -args {zeros(n,1,'double'),zeros(n,1,'double'),zeros(nu,1,'double'),double(0),zeros(n,N+1,'double'),zeros(nu+1,nu+1,'double'),double(1),int8(1),double(1),zeros(n,1,'double'),zeros(n,1,'double'),zeros(n,nu,'double'),zeros(n,nu,'double'),zeros(n,nw,'double')}
% u = compute_u_ccm(x, x_nom, u_nom, Erem, gamma_s, ...
